        ...
        <Grid container>
          <ItemGrid xs={12} sm={12} md={6}>
            <RegularCard
              ...
              content={
                <img alt="afd" src={QingSheBaseImg} className={classes.gridImg} onClick={this.props.onClick}/>
              }
              collapse={
                <RoomZhucai />
              }
          ...
          <ItemGrid xs={12} sm={12} md={6}>
            <RegularCard
              ...
              cardSubtitle="天花：石膏板吊顶，200元，墙面：乳胶漆+木饰面，2000元，地面：石材，1200元"
              content={
                <img alt="adf" src={QingSheUpgradeImg} className={classes.gridImg} onClick={this.props.onClick}/>
              }
              collapse={
                <RoomZhucai />
              }
